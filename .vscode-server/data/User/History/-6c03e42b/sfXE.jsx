...
import { fetchWithAuth } from "../helpers/fetchWithAuth"; // ← importa el helper correcto
...
export default function AdminSolicitudes() {
  ...
  const fetchSolicitudes = async () => {
    ...
    try {
      const data = await fetchWithAuth('/admin/solicitudes', {
        method: 'GET',
      }, token);
  ...
  const updateEstado = async (id, nuevoEstado) => {
    try {
      const token = localStorage.getItem("token");
      await fetchWithAuth(`/admin/solicitudes/${id}/estado`, {
        method: "PUT",
