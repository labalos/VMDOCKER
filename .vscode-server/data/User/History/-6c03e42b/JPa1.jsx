...
export default function AdminSolicitudes() {
  ...
  const getEstadoBadgeClass = (estado) => {
    switch (estado) {
      case "nuevo":
        return styles.badgeNuevo;
      case "contactado":
        return styles.badgeContactado;
      case "cerrado":
          ...
          <Card key={solicitud._id} className={styles.solicitudCard}>
            <CardBody>
              ...
              <div className={styles.details}>
                <p>
                  <strong>Service:</strong> {solicitud.service}
                </p>
                <p>
                  <strong>Phone:</strong> {solicitud.telefono}
                </p>
                {solicitud.email && (
                  <p>
                ...
                {solicitud.ubicacion && (
                  <p>
                    <strong>Location:</strong> {solicitud.ubicacion}
                  </p>
                )}
                {solicitud.presupuesto && (
                  <p>
                    <strong>Budget:</strong> ${solicitud.presupuesto}
                  </p>
                )}
                {solicitud.mensaje && (
                  <p className={styles.message}>
                    <strong>Message:</strong> {solicitud.mensaje}
                  </p>
                )}
