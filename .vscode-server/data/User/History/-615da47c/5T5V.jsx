...
export default function Formulario() {
  ...
  // 🎯 FUNCIÓN handleSubmit CORREGIDA - SIN DUPLICADOS
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.message.includes("Failed to fetch") || err.message.includes("NetworkError")) {
        ...
        userMessage += "\n1. El backend está corriendo (puerto 3000)";
        userMessage += "\n2. URL: http://localhost:3000/api/solicitudes";
        userMessage += "\n3. No hay errores en la terminal del backend";
      } else if (err.message.includes("404")) {
        userMessage = "Servidor no encontrado. ¿El backend está activo?";
      }
