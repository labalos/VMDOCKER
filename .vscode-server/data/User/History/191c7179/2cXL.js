...
if (process.env.NODE_ENV !== 'test') {
  ...
  process.on('unhandledRejection', (reason, promise) => {
    ...
    shutdown('unhandledRejection'); // Reutilizar la función de cierre elegante
    shutdown('unhandledRejection'); // Reutilizar la función de cierre elegante
  });
  // Forzar cierre después de 10 segundos
  // Forzar cierre después de 10 segundos
  setTimeout(() => { Advertencia: el servidor no se cerró correctamente. Forzando cierre...');
    console.warn('⚠️ Advertencia: el servidor no se cerró correctamente. Forzando cierre...');
    process.exit(1);
  }, 10000);
}
// Exportar app para testing
// Exportar app para testingmodule.exports = app;